  ...
  return (
    <div className="relative">
      ...
      >
        ...
        <span className="text-sm font-semibold text-white">{currentLang?.name}</span>
        <svg 
          width="16" 
          height="16" 
          viewBox="0 0 24 24" 
        ...
        {isOpen && (
          <>
            ...
            <motion.div
              ...
              className="absolute top-full mt-2 right-0 w-48 glass-dark rounded-xl border border-white/10 shadow-2xl overflow-hidden z-50"
            >
              <div className="p-2">
